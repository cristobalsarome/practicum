...
report_filename <- paste0("Reports/NB_",abr_time,"_",file_suffix,".txt")
...
writeLines("Source Filename: Hogares_model_12_NaiveBay_Caret")
...
#WE CREATE THE MODEL
capture.output(home_model_12 <- train(x=training_data[predictor_fields],y=training_data[[target_field]],
                       method = "nb"))
#nb from package Klar
#naive_bayes from package naivebayes #NEVERENDS
